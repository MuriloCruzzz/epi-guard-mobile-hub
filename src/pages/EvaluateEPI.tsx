...
const EvaluateEPI: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-100 pb-16">
      <Header title="AVALIAÇÃO DE EPI" showBack />
        ...
        <div className="bg-white rounded-lg p-4 shadow-sm mb-4">
          ...
          <div className="flex justify-between mb-2">
            ...
            <div>
              ...
              <span className="bg-destructive text-white px-3 py-1 rounded-md text-sm font-bold">
                AVALIAR
              </span>
            </div>
          </div>
